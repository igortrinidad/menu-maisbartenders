<template>
    <div class="first-container">
        ...
        <router-link tag="button" class="btn btn-fixed-bottom btn-mb-info" style="position: fixed"
                     :to="{ name: 'landing.events.list' }" exact>
    ...
    export default {
        ...
        methods: {
            ...
            removeEvent: function (event) {
                ...
                that.$swal({
                    title: that.translations.remove_alert.title,
                    input: 'text',
                    showCancelButton: true,
                    confirmButtonText: that.translations.remove_alert.confirm_button,
                    cancelButtonText: that.translations.remove_alert.cancel_button,
                    ...
                    that.$swal({
                        type: 'success',
                        title: that.translations.remove_success
                    })
